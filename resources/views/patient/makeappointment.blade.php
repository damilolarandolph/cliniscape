            ...
            <form method="POST" class="">
                ...
                <div class="col">
                    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" id="pills-home-{{$loop->iteration}}" data-toggle="pill"
                                href="#pills-home-{{$loop->iteration}}" role="tab" aria-controls="pills-home"
                                aria-selected="true">
                    ...
                    <div class="tab-content" id="pills-tabContent">
                        <div class="tab-pane fade show active" id="pills-content-{{$loop->iteration}}" role="tabpanel"
                            aria-labelledby="pills-home-{{$loop->iteration}}">
                        ...
                        <ul class="list-group">
                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                ...
                                <span class="align-middle">
                                    <input type="radio" name="doctoremail" id="exampleRadios1"
                                        value="{{$doctorTypeMap->doctor->email}}">
                                </span>
                            </li>
                            @endforeach
                        </ul>
