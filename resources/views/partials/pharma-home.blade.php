@inject('prescriptions', 'App\Prescription')
@inject('medicines', 'App\Medicine')
@inject('medicalSupplies', 'App\MedicalSupply')
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <h1 class="text-primary display-3 m-0 p-">
                                        {{$prescriptions::getCollected()['waiting']}}
                                    </h1>
                        ...
                        <div class="col  border-left">
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <h1 class="text-primary display-3 m-0 p-">
                                        {{$prescriptions::getCollected()['collected']}}
                                    </h1>
                                    <p class="text-primary">
            ...
            <div class="card h-100">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col">
                            Today's Prescriptions({{count($prescriptions::todaysPrescriptions())}})
                        </div>
                    ...
                    <div class="row">
                        <div class="col-3">
                            ...
                            <h2 class="display-1 p-0 m-0">
                                {{count($prescriptions::todaysPrescriptions())}}
                            </h2>

                        </div>

                        @foreach($prescriptions::todaysPrescriptions() as $prescription)
        ...
        <div class="col">
            <div class="card h-100">
                <div class="card-body">
                    ...
                    @foreach($prescriptions::rankPrescriptions() as $key=>$value)
                    @if($loop->iteration == 7)
                    @break
                    @endif
                    <div class="row mb-2">
        ...
        <div class="col">
            ...
            <div class="card h-100">
                <div class="card-body">
                    ...
                    @foreach($medicines::lowStockMedicine() as $key=>$value)
                    @if($loop->iteration == 7 || $value['quantity'] > 100)
                    @break
                    @endif
                    <div class="row mb-2">
                        <div class="col">
                            <h6>{{"{$loop->iteration}. {$value['name']} ({$value['dosage']})"}} - <span
                                    class="text-danger">{{"{$value['quantity']} is left"}}</span></h6>
                        </div>
                    </div>
        ...
        <div class="col">
            ...
            <div class="card h-100">
                <div class="card-body">
                    ...
                    @foreach($medicalSupplies::lowStockMedicine() as $key=>$value)
                    @if($loop->iteration == 7 || $value['quantity'] > 100)
                    @break
                    @endif
                    <div class="row mb-2">
                        <div class="col">
                            <h6>{{"{$loop->iteration}. {$value['name']} "}} - <span
                                    class="text-danger">{{"{$value['quantity']} is left"}}</span></h6>
                        </div>
                    </div>
                    @endforeach
