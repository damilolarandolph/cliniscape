                    ...
                    <div class="row">
                        <div class="col">
                            <h1>
                                ...
                                Good Day, Dr
                                @else
                                Good Day, {{$user->userDetails->basic_details['title']}}
                                @endif
                            </h1>
                            <h4 class="">
                                {{$user->fullname()}}.
                    ...
                    <div class="row h-50">
                            ...
                            <div class="row">
                                <div class="col">
                                    <h1 class="text-primary display-3 m-0 p-">
                                        {{count($user->pendingAppointments())}}
                                    </h1>
                                    <p class="text-primary">
                                        Appointments waiting to be scheduled
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="col  border-left">
                            ...
                            <div class="row">
                                <div class="col">
                                    <h1 class="text-primary display-3 m-0 p-">
                                        {{count($user->scheduledAppointments())}}
                                    </h1>
                                    <p class="text-primary">
        ...
        <div class="col">
            <div class="card h-100">
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                            Today's Appointments({{count($user->todaysAppointments())}})
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-3">
                            <h2 class="display-1 p-0 m-0">
                                {{count($user->todaysAppointments())}}
                            </h2>
                        </div>
                        @foreach($user->todaysAppointments() as $appointment)
                        <div class="col  align-self-center">
                            <div class="row bg-primary text-white rounded">
                                ...
                                <div class="col align-self-center">
                                    <div class="row">
                                        <div class="col">
                                            {{$appointment->appointment_details['start-time']}}
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="col">
            <div class="card h-100">
                <div class="card-body">
                    ...
                    @foreach($user->rankTreatments() as $key=>$value)
                    <div class="row mb-2">
                        <div class="col">
