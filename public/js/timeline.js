...
*/
! function (e, t) {
    "object" == typeof exports && "undefined" != typeof module ? t(exports, require("@fullcalendar/core")) : "function" == typeof define && define.amd ? define(["exports", "@fullcalendar/core"], t) : t((e = e || self).FullCalendarTimeline = {}, e.FullCalendar)
}(this, function (e, t) {
    "use strict";
    var r = function (e, t) {
    ...
    var i, o = function () {
        ...
        l = function () {
            function e() {
                this.gutters = {}, this.el = t.htmlToElement('<div class="fc-scroller-canvas"> <div class="fc-content"></div> <div class="fc-bg"></div> </div>'), this.contentEl = this.el.querySelector(".fc-content"), this.bgEl = this.el.querySelector(".fc-bg")
            }
            return e.prototype.setGutters = function (e) {
                ...
                var e = this.gutters,
                    r = this.el;
                t.forceClassName(r, "fc-gutter-left", e.left), t.forceClassName(r, "fc-gutter-right", e.right), t.forceClassName(r, "fc-gutter-top", e.top), t.forceClassName(r, "fc-gutter-bottom", e.bottom), t.applyStyle(r, {
                    paddingLeft: e.left || "",
        ...
        s = function (e) {
            function r(r, n) {
                ...
                return i.reportScroll = function () {
                ...
                }, i.isScrolling = !1, i.isTouching = !1, i.isMoving = !1, i.isTouchScrollEnabled = !0, i.requestMovingEnd = t.debounce(i.reportMovingEnd, 500), i.canvas = new l, i.el.appendChild(i.canvas.el), i.applyOverflow(), i.bindHandlers(), i
            }
            return n(r, e), r.prototype.destroy = function () {
                ...
                this.el.addEventListener("scroll", this.reportScroll), this.el.addEventListener("touchstart", this.reportTouchStart, {
                    passive: !0
                }), this.el.addEventListener("touchend", this.reportTouchEnd)
            }, r.prototype.unbindHandlers = function () {
                this.el.removeEventListener("scroll", this.reportScroll), this.el.removeEventListener("touchstart", this.reportTouchStart, {
                    passive: !0
    ...
    var c = function () {
            function e(e, r, n) {
                this.isHScrollbarsClipped = !1, this.isVScrollbarsClipped = !1, "clipped-scroll" === e && (e = "scroll", this.isHScrollbarsClipped = !0), "clipped-scroll" === r && (r = "scroll", this.isVScrollbarsClipped = !0), this.enhancedScroll = new s(e, r), n.appendChild(this.el = t.createElement("div", {
        ...
        d = function () {
            ...
            return e.prototype.initScroller = function (e) {
                ...
                for (var e, t, r = this.scrollers.map(function (e) {
                        return e.getScrollbarWidths()
                    }), n = 0, i = 0, o = 0, l = 0, s = 0, a = r; s < a.length; s++) e = a[s], n = Math.max(n, e.left), i = Math.max(i, e.right), o = Math.max(o, e.top), l = Math.max(l, e.bottom);
                for (t = 0; t < this.scrollers.length; t++) {
                    var c = this.scrollers[t];
                    e = r[t], c.enhancedScroll.canvas.setGutters("horizontal" === this.axis ? {
                        left: n - e.left,
                        right: i - e.right
                    } : {
                        top: o - e.top,
        ...
        h = function () {
            function e(e, t, r) {
                this.headerScroller = new c("clipped-scroll", "hidden", e), this.bodyScroller = new c("auto", r, t), this.scrollJoiner = new d("horizontal", [this.headerScroller, this.bodyScroller])
            }
            return e.prototype.destroy = function () {
        ...
        u = function (e) {
            function r(t) {
                ...
                return r.parentEl = t, r
            }
            return n(r, e), r.prototype.firstContext = function (e) {
                this.parentEl.appendChild(this.tableEl = t.createElement("table", {
                    className: e.theme.getClass("tableGrid")
                }))
                ...
                for (var r = this.context, n = r.dateEnv, i = r.theme, o = e.cellRows, l = o[o.length - 1], s = t.asRoughMs(e.labelInterval) > t.asRoughMs(e.slotDuration), a = t.isSingleDay(e.slotDuration), c = "<colgroup>", d = e.slotCnt - 1; d >= 0; d--) c += "<col/>";
                c += "</colgroup>", c += "<tbody>";
                for (var h = 0, u = o; h < u.length; h++) {
                    var p = u[h];
                    c += "<tr" + (s && p === l ? ' class="fc-chrono"' : "") + ">";
                    for (var f = 0, m = p; f < m.length; f++) {
                        var g = m[f],
                            v = [i.getClass("widgetHeader")];
                        g.isWeekStart && v.push("fc-em-cell"), a && (v = v.concat(t.getDayClasses(g.date, this.props.dateProfile, this.context, !0))), c += '<th class="' + v.join(" ") + '" data-date="' + n.formatIso(g.date, {
                            omitTime: !e.isTimeScale,
                            omitTimeZoneOffset: !0
                        }) + '"' + (g.colspan > 1 ? ' colspan="' + g.colspan + '"' : "") + '><div class="fc-cell-content">' + g.spanHtml + "</div></th>"
                    }
                    c += "</tr>"
                }
                c += "</tbody>", this.tableEl.innerHTML = c, this.slatColEls = t.findElements(this.tableEl, "col"), this.innerEls = t.findElements(this.tableEl.querySelector("tr:last-child"), "th .fc-cell-text"), t.findElements(this.tableEl.querySelectorAll("tr:not(:last-child)"), "th .fc-cell-text").forEach(function (e) {
        ...
        p = function (e) {
            function r(r) {
                ...
                return r.appendChild(n.el = t.createElement("div", {
                    className: "fc-slats"
                })), n
            }
            return n(r, e), r.prototype.destroy = function () {
                ...
                for (var r = this.context, n = r.calendar, i = r.view, o = r.theme, l = r.dateEnv, s = e.slotDates, a = e.isWeekStarts, c = '<table class="' + o.getClass("tableGrid") + '"><colgroup>', d = 0; d < s.length; d++) c += "<col/>";
                c += "</colgroup>", c += "<tbody><tr>";
                for (d = 0; d < s.length; d++) c += this.slatCellHtml(s[d], a[d], e);
                c += "</tr></tbody></table>", this.el.innerHTML = c, this.slatColEls = t.findElements(this.el, "col"), this.slatEls = t.findElements(this.el, "td");
                for (d = 0; d < s.length; d++) n.publiclyTrigger("dayRender", [{
                    date: l.toDate(s[d]),
                    el: this.slatEls[d],
                    view: i
                }]);
                ...
                var i, o = this.context,
                    l = o.theme,
                    s = o.dateEnv;
                return n.isTimeScale ? (i = []).push(t.isInt(s.countDurationsBetween(n.normalizedRange.start, e, n.labelInterval)) ? "fc-major" : "fc-minor") : (i = t.getDayClasses(e, this.props.dateProfile, this.context)).push("fc-day"), i.unshift(l.getClass("widgetContent")), r && i.push("fc-em-cell"), '<td class="' + i.join(" ") + '" data-date="' + s.formatIso(e, {
                ...
                var r = this.outerCoordCache,
                    ...
                    i = n.dateEnv,
                    o = n.isRtl,
                    l = this.props.tDateProfile,
                    s = r.leftToIndex(e);
                if (null != s) {
                    var a = r.getWidth(s),
                        c = o ? (r.rights[s] - e) / a : (e - r.lefts[s]) / a,
                        d = Math.floor(c * l.snapsPerSlot),
                        h = i.add(l.slotDates[s], t.multiplyDuration(l.snapDuration, d));
                    return {
                        dateSpan: {
                            range: {
                                start: h,
                                end: i.add(h, l.snapDuration)
                            },
    ...
    function y(e, r, n, i) {
        var o = {
            labelInterval: E(n, "slotLabelInterval"),
            slotDuration: E(n, "slotDuration")
        };
        ! function (e, r, n) {
        ...
        var l = n.slotLabelFormat,
            s = Array.isArray(l) ? l : null != l ? [l] : function (e, r, n, i) {
        ...
        o.headerFormats = s.map(function (e) {
            return t.createFormatter(e)
        }), o.isTimeScale = Boolean(o.slotDuration.milliseconds);
        var a = null;
        if (!o.isTimeScale) {
            var c = t.greatestDurationDenominator(o.slotDuration).unit;
            /year|month|week/.test(c) && (a = c)
        }
        o.largeUnit = a, o.emphasizeWeeks = t.isSingleDay(o.slotDuration) && w("weeks", e, r) >= 2 && !n.businessHours;
        var d, h, u = n.snapDuration;
        u && (d = t.createDuration(u), h = t.wholeDivideDurations(o.slotDuration, d)), null == h && (d = o.slotDuration, h = 1), o.snapDuration = d, o.snapsPerSlot = h;
        var p = t.asRoughMs(e.maxTime) - t.asRoughMs(e.minTime),
            f = S(e.renderRange.start, o, r),
            y = S(e.renderRange.end, o, r);
        o.isTimeScale && (f = r.add(f, e.minTime), y = r.add(t.addDays(y, -1), e.maxTime)), o.timeWindowMs = p, o.normalizedRange = {
            start: f,
            end: y
        };
        for (var T = [], x = f; x < y;) b(x, o, e, i) && T.push(x), x = r.add(x, o.slotDuration);
        o.slotDates = T;
        var R = -1,
            k = 0,
            z = [],
            M = [];
        for (x = f; x < y;) b(x, o, e, i) ? (R++, z.push(R), M.push(k)) : z.push(R + .5), x = r.add(x, o.snapDuration), k++;
        return o.snapDiffToIndex = z, o.snapIndexToDiff = M, o.snapCnt = R + 1, o.slotCnt = o.snapCnt / o.snapsPerSlot, o.isWeekStarts = function (e, t) {
            ...
            return o
        }(o, r), o.cellRows = function (e, r, n) {
            for (var i = e.slotDates, o = e.headerFormats, l = o.map(function (e) {
                    return []
                }), s = o.map(function (e) {
                ...
                for (var c = i[a], d = e.isWeekStarts[a], h = 0; h < o.length; h++) {
                    var u = o[h],
                        p = l[h],
                        f = p[p.length - 1],
                        m = o.length > 1 && h < o.length - 1,
                        g = null;
                    if (m) {
                        var v = r.format(c, u);
                        f && f.text === v ? f.colspan += 1 : g = C(c, v, s[h], n, r)
                    } else if (!f || t.isInt(r.countDurationsBetween(e.normalizedRange.start, c, e.labelInterval))) {
                        var v = r.format(c, u);
                        g = C(c, v, s[h], n, r)
                    } else f.colspan += 1;
                    g && (g.weekStart = d, p.push(g))
                }
            return l
        }(o, r, n), o
    }
    ...
    function D(e, r, n) {
        ...
        if (!o) {
            ...
            if (e.slotDuration) {
                ...
                for (var h = 0, u = v; h < u.length; h++) {
                    if (l = u[h], o = t.createDuration(l), n.countDurationsBetween(i.start, i.end, o) >= f) break
                }
            e.labelInterval = o
        }
        return o
    ...
    function C(e, r, n, i, o) {
        return {
            text: r,
            spanHtml: t.buildGotoAnchorHtml(i, o, {
                date: e,
                type: n,
                forceOff: !n
            }, {
    ...
    var T, x = function () {
            ...
            return e.prototype.render = function (e, r) {
                ...
                this.headParent.appendChild(this.arrowEl = t.createElement("div", {
                    className: "fc-now-indicator fc-now-indicator-arrow",
                    style: n
                })), this.bodyParent.appendChild(this.lineEl = t.createElement("div", {
        ...
        R = -1 !== (T = t.htmlToElement('<div style="position:-webkit-sticky;position:sticky"></div>').style.position).indexOf("sticky") ? T : null,
        ...
        I = function () {
            function e(e, r, n) {
                ...
                this.usingRelative = null, this.updateSize = function () {
                    var e = Array.prototype.slice.call(i.scroller.canvas.el.querySelectorAll("." + M)),
                        r = i.queryElGeoms(e),
                    ...
                    i.usingRelative ? function (e, r, n) {
                        e.forEach(function (e, i) {
                            ...
                            t.applyStyle(e, {
                                position: "relative",
                                left: n[i].left - o.left,
                                top: n[i].top - o.top
                            })
                        })
                    }(e, r, i.computeElDestinations(r, n)) : function (e, r, n) {
                        e.forEach(function (e, i) {
                            var o = 0;
                            "center" === r[i].intendedTextAlign && (o = (n - r[i].elWidth) / 2, "center" === r[i].computedTextAlign && (e.setAttribute("data-sticky-center", ""), e.parentNode.style.textAlign = "left")), t.applyStyle(e, {
                                position: R,
                                left: o,
                                right: 0,
                                top: 0
                ...
                }, this.scroller = e, this.usingRelative = !R || k && r || (k || z) && n, this.usingRelative && e.on("scrollEnd", this.updateSize)
            }
            return e.prototype.destroy = function () {
                ...
                for (var r = this.scroller.canvas.el.getBoundingClientRect(), n = [], i = 0, o = e; i < o.length; i++) {
                    var l = o[i],
                        ...
                        h = d,
                        u = null;
                    "sticky" !== c.position && (u = t.translateRect(a, -r.left - (parseFloat(c.left) || 0), -r.top - (parseFloat(c.top) || 0))), l.hasAttribute("data-sticky-center") && (h = "center"), n.push({
                        parentBound: s,
                        naturalBound: u,
                        elWidth: a.width,
                        elHeight: a.height,
                ...
                return e.map(function (e) {
                    ...
                    return t = Math.min(t, a.right - l), t = Math.max(t, a.left), o = n, o = Math.min(o, a.bottom - s), {
                        left: t,
    ...
    var P = function (e) {
            function r(r, n) {
                ...
                return i.renderSkeleton = t.memoizeRendering(i._renderSkeleton, i._unrenderSkeleton), i.layout = new h(r, n, "auto"), i
            }
            return n(r, e), r.prototype.render = function (e, t) {
                var r = this.tDateProfile = y(e.dateProfile, t.dateEnv, t.options, e.dateProfileGenerator);
                this.renderSkeleton(t), this.header.receiveProps({
                    dateProfile: e.dateProfile,
                    tDateProfile: r
                }, t), this.slats.receiveProps({
                    dateProfile: e.dateProfile,
                    tDateProfile: r
                }, t)
            }, r.prototype.destroy = function () {
                this.renderSkeleton.unrender(), this.layout.destroy(), e.prototype.destroy.call(this)
            }, r.prototype._renderSkeleton = function (e) {
                var t = this.layout,
                    r = t.headerScroller.enhancedScroll,
                    n = t.bodyScroller.enhancedScroll;
                this.headStickyScroller = new I(r, e.isRtl, !1), this.bodyStickyScroller = new I(n, e.isRtl, !1), this.header = new u(r.canvas.contentEl), this.slats = new p(n.canvas.bgEl), this.nowIndicator = new x(r.canvas.el, n.canvas.el)
            }, r.prototype._unrenderSkeleton = function () {
                this.header.destroy(), this.slats.destroy(), this.nowIndicator.unrender(), this.headStickyScroller.destroy(), this.bodyStickyScroller.destroy()
            }, r.prototype.getNowIndicatorUnit = function (e, r) {
                var n = this.context,
                    i = this.tDateProfile = y(e, n.dateEnv, n.options, r);
                if (i.isTimeScale) return t.greatestDurationDenominator(i.slotDuration).unit
            }, r.prototype.renderNowIndicator = function (e) {
                t.rangeContainsMarker(this.tDateProfile.normalizedRange, e) && this.nowIndicator.render(this.dateToCoord(e), this.context.isRtl)
                ...
                var e = this.context.options.slotWidth || "";
                ...
                this.header.innerEls.forEach(function (e, t) {
                    r = Math.max(r, e.getBoundingClientRect().width)
                });
                var n = Math.ceil(r) + 1,
                ...
                t.headerScroller.enhancedScroll.canvas.setWidth(n), t.headerScroller.enhancedScroll.canvas.setMinWidth(i), t.bodyScroller.enhancedScroll.canvas.setWidth(n), t.bodyScroller.enhancedScroll.canvas.setMinWidth(i), "" !== o && this.header.slatColEls.slice(0, -1).concat(this.slats.slatColEls.slice(0, -1)).forEach(function (e) {
                    e.style.width = o + "px"
                })
            }, r.prototype.computeDateSnapCoverage = function (e) {
                var r = this.tDateProfile,
                    n = this.context.dateEnv.countDurationsBetween(r.normalizedRange.start, e, r.snapDuration);
                if (n < 0) return 0;
                if (n >= r.snapDiffToIndex.length) return r.snapCnt;
                var i = Math.floor(n),
                    o = r.snapDiffToIndex[i];
                return t.isInt(o) ? o += n - i : o = Math.ceil(o), o
                ...
                var t = this.tDateProfile,
                    ...
                    l = o.innerCoordCache,
                    s = o.outerCoordCache;
                return this.context.isRtl ? s.rights[n] - l.getWidth(n) * i - s.originClientRect.width : s.lefts[n] + l.getWidth(n) * i
                ...
                var r = this.context,
                    ...
                    l = 0;
                return o && (l = this.dateToCoord(n.add(t.startOfDay(o.activeRange.start), e)), !i && l && (l += 1)), {
                    left: l
                }
        ...
        L = function (e) {
            function r(t, r) {
                var n = e.call(this) || this;
                return n.masterContainerEl = t, n.timeAxis = r, n
            }
            return n(r, e), r.prototype.renderSegHtml = function (e, r) {
                var n = this.context,
                    ...
                    o = i.def,
                    l = i.ui,
                    s = t.computeEventDraggable(n, o, l),
                    a = e.isStart && t.computeEventStartResizable(n, o, l),
                    c = e.isEnd && t.computeEventEndResizable(n, o, l),
                ...
                if (!this.el && this.masterContainerEl && (this.el = t.createElement("div", {
                        className: "fc-event-container"
                    }), r && this.el.classList.add("fc-mirror-container"), this.masterContainerEl.appendChild(this.el)), this.el)
    ...
    function W(e) {
        return null == e.top && (e.top = H(e.above)), e.top + e.height
    }
    ...
    var B = function (e) {
        ...
        _ = function (e) {
            function r(r, n, i) {
                ...
                o.slicer = new O, o.renderEventDrag = t.memoizeRendering(o._renderEventDrag, o._unrenderEventDrag), o.renderEventResize = t.memoizeRendering(o._renderEventResize, o._unrenderEventResize), o.fgContainerEl = r, o.timeAxis = i;
                var l = o.fillRenderer = new B(n, i),
                    s = o.eventRenderer = new L(r, i);
                return o.mirrorRenderer = new L(r, i), o.renderBusinessHours = t.memoizeRendering(l.renderSegs.bind(l, "businessHours"), l.unrender.bind(l, "businessHours")), o.renderDateSelection = t.memoizeRendering(l.renderSegs.bind(l, "highlight"), l.unrender.bind(l, "highlight")), o.renderBgEvents = t.memoizeRendering(l.renderSegs.bind(l, "bgEvent"), l.unrender.bind(l, "bgEvent")), o.renderFgEvents = t.memoizeRendering(s.renderSegs.bind(s), s.unrender.bind(s)), o.renderEventSelection = t.memoizeRendering(s.selectByInstanceId.bind(s), s.unselectByInstanceId.bind(s), [o.renderFgEvents]), o
            }
            return n(r, e), r.prototype.render = function (e, t) {
                var r = this.timeAxis,
                    n = this.slicer.sliceProps(e, e.dateProfile, r.tDateProfile.isTimeScale ? null : e.nextDayThreshold, t.calendar, this, r);
                this.renderBusinessHours(t, n.businessHourSegs), this.renderDateSelection(t, n.dateSelectionSegs), this.renderBgEvents(t, n.bgEventSegs), this.renderFgEvents(t, n.fgEventSegs), this.renderEventSelection(n.eventSelection), this.renderEventDrag(n.eventDrag), this.renderEventResize(n.eventResize)
            }, r.prototype.destroy = function () {
                e.prototype.destroy.call(this), this.renderBusinessHours.unrender(), this.renderDateSelection.unrender(), this.renderBgEvents.unrender(), this.renderFgEvents.unrender(), this.renderEventSelection.unrender(), this.renderEventDrag.unrender(), this.renderEventResize.unrender()
                ...
                if (e) {
                    ...
                    this.eventRenderer.hideByHash(e.affectedInstances), this.fillRenderer.renderSegs("highlight", this.context, t), this.mirrorRenderer.renderSegs(this.context, e.segs, {
                        isDragging: !0,
                        sourceSeg: e.sourceSeg
                    })
                }
                ...
                var n = r.tDateProfile,
                    ...
                    s = function (e, r, n) {
                        if (!r.isTimeScale && (e = t.computeVisibleDayRange(e), r.largeUnit)) {
                            var i = e;
                            ((e = {
                                start: n.startOf(e.start, r.largeUnit),
                                end: n.startOf(e.end, r.largeUnit)
                            }).end.valueOf() !== i.end.valueOf() || e.end <= e.start) && (e = {
                                start: e.start,
                                end: n.add(e.end, r.slotDuration)
                            })
                        }
                        return e
                    }(e, n, r.context.dateEnv),
                    a = [];
                if (r.computeDateSnapCoverage(s.start) < r.computeDateSnapCoverage(s.end)) {
                    var c = t.intersectRanges(s, n.normalizedRange);
                    c && a.push({
                        start: c.start,
                        end: c.end,
                        isStart: c.start.valueOf() === s.start.valueOf() && b(c.start, n, o, l),
                        isEnd: c.end.valueOf() === s.end.valueOf() && b(t.addMs(c.end, -1), n, o, l)
                    })
                }
                return a
            }, r
        ...
        N = function (e) {
            function r() {
                ...
                return r.renderSkeleton = t.memoizeRendering(r._renderSkeleton, r._unrenderSkeleton), r.startInteractive = t.memoizeRendering(r._startInteractive, r._stopInteractive), r
            }
            return n(r, e), r.prototype._startInteractive = function (e) {
                this.context.calendar.registerInteractiveComponent(this, {
                    el: e
                })
            }, r.prototype._stopInteractive = function () {
                this.context.calendar.unregisterInteractiveComponent(this)
            }, r.prototype.render = function (t, r) {
                e.prototype.render.call(this, t, r), this.renderSkeleton(this.context), this.timeAxis.receiveProps({
                    dateProfileGenerator: t.dateProfileGenerator,
                    dateProfile: t.dateProfile
                }, r), this.startInteractive(this.timeAxis.slats.el), this.lane.receiveProps(o({}, t, {
                    nextDayThreshold: this.context.nextDayThreshold
                }), r), this.startNowIndicator(t.dateProfile, t.dateProfileGenerator)
            }, r.prototype.destroy = function () {
                this.startInteractive.unrender(), this.renderSkeleton.unrender(), e.prototype.destroy.call(this)
            }, r.prototype._renderSkeleton = function (e) {
                this.el.classList.add("fc-timeline"), !1 === e.options.eventOverlap && this.el.classList.add("fc-no-overlap"), this.el.innerHTML = this.renderSkeletonHtml(), this.timeAxis = new P(this.el.querySelector("thead .fc-time-area"), this.el.querySelector("tbody .fc-time-area")), this.lane = new _(this.timeAxis.layout.bodyScroller.enhancedScroll.canvas.contentEl, this.timeAxis.layout.bodyScroller.enhancedScroll.canvas.bgEl, this.timeAxis)
            }, r.prototype._unrenderSkeleton = function () {
                this.el.classList.remove("fc-timeline"), this.el.classList.remove("fc-no-overlap"), this.timeAxis.destroy(), this.lane.destroy()
            ...
            }, r.prototype.getNowIndicatorUnit = function (e, t) {
                return this.timeAxis.getNowIndicatorUnit(e, t)
            }, r.prototype.renderNowIndicator = function (e) {
            ...
            }, r.prototype.applyScroll = function (t, r) {
                e.prototype.applyScroll.call(this, t, r);
                var n = this.context.calendar;
            ...
            }, r.prototype.queryHit = function (e, t, r, n) {
    ...
    e.HeaderBodyLayout = h, e.ScrollJoiner = d, e.StickyScroller = I, e.TimeAxis = P, e.TimelineLane = _, e.TimelineView = N, e.default = F, Object.defineProperty(e, "__esModule", {
        value: !0
    })
});
