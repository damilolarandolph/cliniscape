...
! function (e, t) {
    ...
    var s = function (e) {
            ...
            }, n.prototype.detachSegs = function () {}, n.prototype.renderSegHtml = function (e) {
        ...
        o = function (e) {
            ...
            return r(n, e), n.prototype.firstContext = function (e) {
                ...
                for (r = 0; r < n.length; r++)
                    if ((s = t.intersectRanges(d, n[r])) && (o = {
                            component: this,
                            eventRange: e,
                            start: s.start,
                            end: s.end,
                ...
                var n, r, s, o = this.context.theme,
                ...
                for (n = 0; n < i.length; n++)
                    if (r = i[n])
                        for (l.appendChild(this.buildDayHeaderRow(this.dayDates[n])), r = this.eventRenderer.sortEventSegs(r), s = 0; s < r.length; s++) l.appendChild(r[s].el);
                ...
                return t.createElement("tr", {
                    ...
                    "data-date": s.formatIso(e, {
                        omitTime: !0
                    })
                }, '<td class="' + (r.getClass("tableListHeading") || r.getClass("widgetHeader")) + '" colspan="3">' + (i ? t.buildGotoAnchorHtml(o, s, e, {
                    class: "fc-list-heading-main"
                }, t.htmlEscape(s.format(e, i))) : "") + (a ? t.buildGotoAnchorHtml(o, s, e, {
                    class: "fc-list-heading-alt"
                }, t.htmlEscape(s.format(e, a))) : "") + "</td>")
            }, n
        }(t.View);
    ...
    e.ListView = o, e.default = a, Object.defineProperty(e, "__esModule", {
        value: !0
    })
});
